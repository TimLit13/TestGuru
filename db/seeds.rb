...
TESTS_SEED.times do
  ...
  test_ready = true
  test_timer = rand(1..15)
  tests.push(Test.create!(title: test_title, level: test_level, category_id: test_category_id, author: test_author, ready: test_ready, timer: test_timer))
end
